import { GOOGLE_TRANSLATE_ORIGINAL_DOM_ID } from '../languages'
...
export function createGoogleTranslateJsonpCallback(
  ...
  if (!pageLanguage) throwError('createGoogleTranslateJsonpCallback', 'pageLanguage is required.')
  ...
  function googleTranslateElementInit() {
    if (window.google && window.google.translate) {
      ...
      throwError('googleTranslateElementInit', 'please check window.google & window.google.translate')
    }
  }
...
export type CreateGoogleTranslateJsonpCallbackReturn = ReturnType<typeof createGoogleTranslateJsonpCallback>

export function GoogleTranslateFireEvent(GOOGLE_TRANSLATE_ORIGINAL_SELECT_DOM: HTMLElement, eventName = 'change') {
  try {
