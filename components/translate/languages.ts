...
export type LanguageCode = (typeof GOOGLE_TRANSLATE_SELECT_LANGUAGES_CODES)[number]
...
export const GOOGLE_TRANSLATE_JSSDK_URL = '//translate.google.com/translate_a/element.js'
...
export const COMPONENT_PREFIX = 'google-translate'
export const COMPONENT_PREFIX_CAMELCASE_NAME = 'GoogleTranslate'
