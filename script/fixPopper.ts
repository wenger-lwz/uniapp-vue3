...
;(async () => {
  ...
  await copy('.output/server/node_modules/@sxzz/popperjs-es', '.output/server/node_modules/@popperjs/core', { dereference })
  console.log('finish cover @popperjs/core from @sxzz/popperjs-es ...')

  // 因为那边需要index.js ...
  await copy('node_modules/@popperjs/core/dist/index.js', '.output/server/node_modules/@popperjs/core/dist/index.js', { dereference })
