...
const associateAttributes = (attributes: string[] | Array<skuInfoPropsType.propertiesAttribute>, skuId: skuInfoPropsType.defaultSkuId) => {
...
const myUseSkuState = (initialValue: skuInfoPropsDefaultType): [skuInfoSettingType, (propertyIndex: number, attributeIndex: number) => void] => {
...
export { dataSource, getInit, getUnchooseLabel, handleClickAttribute, myUseSkuState }
